    ...
    <div class="py-10">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
            ...
            <div class="grid grid-cols-3 gap-4">
                <div class="bg-white dark:bg-gray-800 rounded-xl shadow p-4 border-l-4 border-brand-500 text-center">
                    <p class="text-2xl font-bold text-brand-600">{{ $totalReservations }}</p>
            ...
            @forelse($trajets as $trajet)
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
                    {{-- En-tête du trajet --}}
                    <div class="flex items-center justify-between px-6 py-4 bg-brand-700 dark:from-gray-700 dark:to-gray-700 border-b dark:border-gray-600">
                        <div>
                        ...
                        <div class="flex items-center gap-3">
                            ...
                            <a href="{{ route('trajets.show', $trajet) }}"
                               class="text-xs bg-brand-100 dark:bg-brand-900/30 text-brand-700 dark:text-brand-300 hover:bg-brand-200 px-3 py-1 rounded-lg transition">
                                Voir →
                            </a>
                        </div>
                    </div>
                        ...
                        <div class="divide-y divide-gray-100 dark:divide-gray-700">
                            @foreach($trajet->reservations as $reservation)
                                ...
                                <div class="px-6 py-4 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 hover:bg-gray-50 dark:hover:bg-gray-700/50 transition">
                                    {{-- Passager --}}
                                    <div class="flex items-center gap-3">
                                        <div class="bg-brand-100 dark:bg-brand-900 rounded-full p-2.5 shrink-0">
                                            <svg class="h-4 w-4 text-brand-600 dark:text-brand-300" fill="none" viewBox="0 0 24 24" stroke="currentColor">
