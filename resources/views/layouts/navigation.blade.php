            ...
            <div class="flex">
                ...
                <div class="shrink-0 flex items-center">
                    <a href="{{ route('dashboard') }}" class="flex items-center gap-2">
                        <div class="h-9 w-9 bg-gradient-to-tr from-indigo-600 to-purple-600 rounded-xl flex items-center justify-center shadow-md">
                        ...
                        <span class="text-xl font-extrabold text-indigo-700 dark:text-indigo-400 tracking-tight">CoRide</span>
                    </a>
                </div>
                    ...
                    <x-slot name="trigger">
                        <button class="inline-flex items-center px-3 py-2 border border-transparent text-sm leading-4 font-medium rounded-md text-gray-500 dark:text-gray-400 bg-white dark:bg-gray-800 hover:text-gray-700 dark:hover:text-gray-300 focus:outline-none transition ease-in-out duration-150">
                            <div class="text-left">
                                ...
                                <div class="text-[11px] text-indigo-500 capitalize font-semibold">{{ str_replace('_', ' ', $user->role) }}</div>
                            </div>
                            <div class="ms-1">
