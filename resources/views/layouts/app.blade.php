...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>{{ config('app.name', 'CoRide') }} — Covoiturage entreprise</title>
        <meta name="description" content="CoRide — Application de covoiturage intelligent pour les salariés d'entreprise. Trouvez un trajet compatible grâce au scoring IA.">
