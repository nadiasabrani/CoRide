<x-app-layout>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            ...
            <a href="{{ route('trajets.index') }}" class="text-sm text-brand-600 hover:underline">← Retour</a>
        </div>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden">
                <div class="bg-brand-700 px-6 py-4">
                    ...
                    <p class="text-brand-200 text-sm">Remplissez les détails pour publier votre trajet</p>
                </div>
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-5">
                        <div>
                            ...
                            <input type="text" name="depart" value="{{ old('depart') }}"
                                   class="w-full border dark:border-gray-600 rounded-lg px-3 py-2 dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-brand-500 focus:border-transparent"
