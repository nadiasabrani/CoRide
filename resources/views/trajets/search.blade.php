            ...
            <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6">
                <form method="GET" action="{{ route('trajets.search') }}" class="space-y-4">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
                        <div>
                            ...
                            <input type="text" name="depart"
                                   ...
                                   class="w-full border dark:border-gray-600 rounded-lg px-3 py-2 text-sm dark:bg-gray-700 dark:text-gray-100 focus:ring-2 focus:ring-brand-500 focus:border-transparent">
                        </div>
                    ...
                    <div class="flex gap-3">
                        <button type="submit"
                                class="inline-flex items-center gap-2 bg-brand-600 hover:bg-brand-700 text-white px-6 py-2.5 rounded-lg font-medium transition">
                            🔍 Filtrer les trajets
                        </button>
            ...
            <div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                                    ...
                                    <div class="flex items-center gap-4">
                                        ...
                                        <div class="flex flex-col items-center">
                                            ...
                                            <span class="text-xs text-brand-600 dark:text-brand-400">🚗</span>
                                        </div>
                                        <div class="text-center">
                                    ...
                                    <div class="flex flex-wrap gap-3 items-center">
                                        ...
                                        <a href="{{ route('trajets.search', ['conducteur_id' => $trajet->conducteur_id]) }}"
                                           ...
                                           class="inline-flex items-center gap-1 px-2.5 py-1 rounded-lg text-xs font-medium bg-gray-100 dark:bg-gray-700 text-gray-700 dark:text-gray-300 hover:bg-brand-100 dark:hover:bg-brand-900/50 hover:text-brand-600 transition">
                ...
                @empty
                    <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-12 text-center">
                        ...
                        <a href="{{ route('trajets.search') }}" class="mt-4 inline-block text-brand-600 hover:underline">
