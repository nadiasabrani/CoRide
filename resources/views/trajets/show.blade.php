    ...
    <div class="py-10">
        <div class="max-w-4xl mx-auto sm:px-6 lg:px-8 space-y-6">
                ...
                <div class="bg-gradient-to-r from-indigo-600 to-purple-600 px-8 py-6 text-white">
                    <div class="flex items-center justify-between">
                        ...
                        <div class="text-right hidden sm:block">
                            ...
                            <p class="text-indigo-200 text-sm">par trajet</p>
                        </div>
                    </div>
                </div>
            ...
            @elseif(!$isPassagerRole)
                <div class="bg-indigo-50 dark:bg-indigo-900/30 border border-indigo-200 dark:border-indigo-700/60 rounded-2xl p-6">
                    <div class="flex items-center justify-between">
                        <div>
                            <p class="font-semibold text-indigo-900 dark:text-indigo-200">ℹ️ Rôle Conducteur uniquement</p>
                            <p class="text-xs text-indigo-700 dark:text-indigo-300 mt-1">Votre rôle actuel est défini comme <strong>Conducteur</strong>. Seuls les employés passagers peuvent évaluer et réserver des trajets.</p>
                        </div>
                        <a href="{{ route('profile.edit') }}" class="text-xs bg-indigo-600 hover:bg-indigo-700 text-white px-4 py-2 rounded-lg font-medium transition">
                            Modifier mon rôle →
                        </a>
                    </div>
                </div>
                ...
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow-lg p-6" id="ia-section">
                    ...
                    <form id="ia-form" class="space-y-4">
                        ...
                        <button type="button" id="btn-calculer-ia"
                                ...
                                class="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white px-6 py-2.5 rounded-lg transition font-medium">
                    ...
                    <div id="ia-result" class="hidden mt-6">
                        <div class="border dark:border-gray-700 rounded-xl p-5 space-y-4">
                            ...
                            <div id="ia-horaire-block" class="hidden">
                                ...
                                <p id="ia-horaire-suggere" class="text-sm font-semibold text-indigo-600 dark:text-indigo-400"></p>
                            </div>
