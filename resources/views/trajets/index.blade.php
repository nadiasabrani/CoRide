        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-4">
                        ...
                        <div class="flex-1 p-5">
                            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                                ...
                                <div class="flex flex-wrap gap-2 items-center">
                                    <span class="text-sm font-bold text-indigo-700 dark:text-indigo-400">{{ $trajet->prix }} DH</span>
                                ...
                                <div class="flex gap-2 items-center">
                                    <a href="{{ route('trajets.show', $trajet) }}"
                                       class="text-sm bg-indigo-50 dark:bg-indigo-900/30 text-indigo-700 dark:text-indigo-300 hover:bg-indigo-100 px-3 py-1.5 rounded-lg transition">
                                        Voir
                                    </a>
            ...
            @empty
                <div class="bg-white dark:bg-gray-800 rounded-2xl shadow p-12 text-center">
                    ...
                    @if(in_array(auth()->user()->role, ['conducteur', 'les_deux']))
                        <a href="{{ route('trajets.create') }}" class="mt-3 inline-block text-indigo-600 hover:underline">
